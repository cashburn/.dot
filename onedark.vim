...
" C++
" call s:h("cCustomClass", { "fg": s:yellow })
...
call s:h("javaClassDecl", { "fg": s:purple })
call s:h("javaObjectProp", { "fg": s:red })
call s:h("javaScopeDecl", { "fg": s:purple })
call s:h("javaFuncCall", { "fg": s:blue })
call s:h("javaObjectFuncName", { "fg": s:blue })
call s:h("javaVariableDef", { "fg": s:red })
call s:h("javaArrayDef", { "fg": s:red })
call s:h("javaObject", { "fg": s:red })
call s:h("javaClassName", { "fg": s:yellow })
...
call s:h("jsVariableDef", { "fg": s:yellow })
